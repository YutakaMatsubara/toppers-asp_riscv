 ...
 *  の責任を負わない．
 * 
 *  @(#) $Id: target_syssvc.h 2246 2018-12-25 21:02:04Z roi $
 */

/*
 *		システムサービスのターゲット依存部（HIFIVE1用）
 *
 ...
 *  起動メッセージのターゲットシステム名
 */
#define TARGET_NAME	"HIFIVE1"

/*
 *  起動メッセージの著作権表示
 */
#define TARGET_COPYRIGHT \
"Copyright (C) 2018-2019 by Education Working Group TOPPERS PROJECT\n" \
